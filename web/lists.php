...
echo '<table>';
mailing_list('audiere-annc', 'Announcements and news related to Audiere.  ' .
             'This is a low-volume list for those who are only interested in ' .
             'new releases.');
mailing_list('audiere-users', 'User information and discussion.  Use this list ' .
             'to get in contact with other Audiere users.');
mailing_list('audiere-devel', 'Developer discussion.  This list is for discussion ' .
             'about the development process and other topics the average user ' .
             'does not care about.  Use this list to reach the developers.');
mailing_list('audiere-commits', 'Relatively high-volume list that logs all CVS ' .

...
<?php download('audiere-doxygen.zip',    'API Reference (.zip format)'); ?>
<?php download('audiere-doxygen.tar.gz', 'API Reference (.tar.gz format)'); ?>
<?php download('audiere.chm',            'API Reference (HTMLHelp format)'); ?>
</ul>
